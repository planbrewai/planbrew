...
server.tool("log_progress", "Quick one-liner to log what you did - just type a message like 'fixed login bug' or 'worked on auth for 2 hours'", logProgressSchema.shape, logProgressHandler);
